...
import com.wildstartech.dispatchtrack.spi.ServiceUnitImpl;
import com.wildstartech.dispatchtrack.spi.xml.XMLElementProcessor;

public class ServiceUnitElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=
         ServiceUnitElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   public static final String elementLabel="service_unit";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            ServiceUnitElementProcessor.elementLabel);
      return ServiceUnitElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((order != null) && (reader != null)) {
         serviceUnit=new ServiceUnitImpl();
         login=reader.getAttributeValue(null, "login");
         name=getElementText(reader);
         serviceUnit.setLogin(login);
         serviceUnit.setName(name);
