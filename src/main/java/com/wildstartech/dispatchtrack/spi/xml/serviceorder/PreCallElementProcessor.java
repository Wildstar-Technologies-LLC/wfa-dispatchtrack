...
import com.wildstartech.dispatchtrack.spi.PreCallImpl;
...
public class PreCallElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=
         PreCallElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="pre_call";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            PreCallElementProcessor.elementLabel);
      return PreCallElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((order != null) && (reader != null)) {
         ...
         if (elementName.equals(elementLabel)) {
            preCall=new PreCallImpl();
            while (reader.hasNext() && !done) {               
               ...
               switch (reader.getEventType()) {
                  case XMLStreamConstants.START_ELEMENT:
                     ...
                     if (elementName.equals("confirmation_status")) {
                  ...
                  case XMLStreamConstants.END_ELEMENT:
                     elementName=reader.getLocalName();
                     if (elementName.equals("pre_call")) {
                        done=true;
                     } // END if (elementName.equals("pre_call"))
                     break;
               } // END switch (reader.getEventType())               
            } // END while (reader.hasNext() && !done)
            order.setPreCall(preCall);
         } // END if (elementName.equals(elementLabel))
      } else {
         if (order == null) {
