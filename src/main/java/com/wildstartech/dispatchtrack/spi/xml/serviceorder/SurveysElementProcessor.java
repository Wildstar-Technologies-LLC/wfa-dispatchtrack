...
import com.wildstartech.dispatchtrack.spi.xml.serviceorder.survey.SurveyXMLFactory;

public class SurveysElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=SurveysElementProcessor.class.getName();
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            SurveysElementProcessor.elementLabel);
      return SurveysElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      SurveyXMLFactory surveyFactory=null;
      Survey survey=null;
      String msg=null;
      
      if ((order != null) && (reader != null)) {
         surveyFactory=new SurveyXMLFactory();
         survey=surveyFactory.parse(reader);
