...
public class ThumbnailElementProcessor 
extends XMLElementProcessor<Image> {
   private static final String _CLASS=
         ThumbnailElementProcessor.class.getName();
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            ThumbnailElementProcessor.elementLabel);
      return ThumbnailElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((image != null) && (reader != null)) {
         thumbnail=getElementText(reader);
