...
public class StateElementProcessor extends XMLElementProcessor<Customer> {
   private static final String _CLASS=StateElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="state";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            StateElementProcessor.elementLabel);
      return StateElementProcessor.elementLabel;
   }
