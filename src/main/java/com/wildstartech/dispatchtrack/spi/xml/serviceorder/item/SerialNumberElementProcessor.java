...
public class SerialNumberElementProcessor 
extends XMLElementProcessor<Item> {
   private static final String _CLASS=
         SerialNumberElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="serial_number";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            SerialNumberElementProcessor.elementLabel);
      return SerialNumberElementProcessor.elementLabel;
   }
