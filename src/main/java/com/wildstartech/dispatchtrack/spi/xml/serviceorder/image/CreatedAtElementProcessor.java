...
public class CreatedAtElementProcessor 
extends XMLElementProcessor<Image> {
   private static final String _CLASS=
         CreatedAtElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="created_at";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            CreatedAtElementProcessor.elementLabel);
      return CreatedAtElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((image != null) && (reader != null)) {
         createdAt=getElementDate(reader);
