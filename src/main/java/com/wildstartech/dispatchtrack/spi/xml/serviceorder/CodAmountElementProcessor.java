...
public class CodAmountElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=CodAmountElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="cod_amount";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            CodAmountElementProcessor.elementLabel);
      return CodAmountElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((order != null) && (reader != null)) {
         codAmount=getElementFloat(reader);
