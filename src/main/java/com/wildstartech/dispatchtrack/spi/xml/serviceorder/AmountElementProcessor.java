...
public class AmountElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=AmountElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="amount";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            AmountElementProcessor.elementLabel);
      return AmountElementProcessor.elementLabel;
   }
