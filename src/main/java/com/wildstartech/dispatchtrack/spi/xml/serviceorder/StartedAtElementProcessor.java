...
public class StartedAtElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=
         StartedAtElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="started_at";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            StartedAtElementProcessor.elementLabel);
      return StartedAtElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((order != null) && (reader != null)) {
         startedAtText=getElementText(reader); 
         startedAt=getXMLTimestampAsDate(startedAtText);
