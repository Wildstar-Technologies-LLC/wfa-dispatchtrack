...
public class SaleSequenceElementProcessor 
extends XMLElementProcessor<Item> {
   private static final String _CLASS=
         SaleSequenceElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="sale_sequence";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            SaleSequenceElementProcessor.elementLabel);
      return SaleSequenceElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((item != null) && (reader != null)) {
         saleSequence=getElementInteger(reader);
         item.setSaleSequence(saleSequence);                  
      }  else {
         if (item == null) {
