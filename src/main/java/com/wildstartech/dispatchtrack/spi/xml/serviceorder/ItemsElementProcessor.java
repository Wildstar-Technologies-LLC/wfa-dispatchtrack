...
public class ItemsElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=ItemsElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="items";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            ItemsElementProcessor.elementLabel);
      return ItemsElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      logger.entering(_CLASS, 
         "processElement(ServiceOrder,XMLStreamReader)",reader);
      ItemsXMLFactory listFactory=null;
      List<Item> items=null;
      String msg=null;
      
      if ((order != null) && (reader != null)) {
         listFactory=new ItemsXMLFactory();
         items=listFactory.parse(reader);
         if (items != null) {
