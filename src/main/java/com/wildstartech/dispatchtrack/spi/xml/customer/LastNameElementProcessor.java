...
public class LastNameElementProcessor 
extends XMLElementProcessor<Customer> {
   private static final String _CLASS=LastNameElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="last_name";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            LastNameElementProcessor.elementLabel);
      return LastNameElementProcessor.elementLabel;
   }
   ...
   public void processElement(Customer customer, XMLStreamReader reader) 
      ...
      if ((customer != null) && (reader != null)) {
         lastName=getElementText(reader);
