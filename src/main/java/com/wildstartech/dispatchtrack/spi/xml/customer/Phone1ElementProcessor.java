...
public class Phone1ElementProcessor extends XMLElementProcessor<Customer> {
   private static final String _CLASS=Phone1ElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="phone1";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            Phone1ElementProcessor.elementLabel);
      return Phone1ElementProcessor.elementLabel;
   }
