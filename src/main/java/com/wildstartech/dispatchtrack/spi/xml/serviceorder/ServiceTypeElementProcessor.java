...
public class ServiceTypeElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=ServiceTypeElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   public static final String elementLabel="service_type";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            ServiceTypeElementProcessor.elementLabel);
      return ServiceTypeElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((order != null) && (reader != null)) {
         serviceType=getElementText(reader);
