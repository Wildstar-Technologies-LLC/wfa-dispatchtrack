...
public class ImagesElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=ImagesElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="images";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            ImagesElementProcessor.elementLabel);
      return ImagesElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      ImagesXMLFactory listFactory=null;
      List<Image> images=null;
      String msg=null;
      
      if ((order != null) && (reader != null)) {
         listFactory=new ImagesXMLFactory();
         images=listFactory.parse(reader);
         if (images != null) {
