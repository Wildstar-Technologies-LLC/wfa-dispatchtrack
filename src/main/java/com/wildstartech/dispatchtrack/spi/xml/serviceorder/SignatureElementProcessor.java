...
import com.wildstartech.dispatchtrack.spi.SignatureImpl;
import com.wildstartech.dispatchtrack.spi.xml.XMLElementProcessor;

public class SignatureElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=
      SignatureElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="signature";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            SignatureElementProcessor.elementLabel);
      return SignatureElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      Date callbackAt=null;
      String callbackCode=null;
      String value=null;
      
      if ((order != null) && (reader != null)) {
         Signature signature=new SignatureImpl();
         value=reader.getAttributeValue(null,"created_at");
         callbackAt=this.getXMLTimestampAsDate(value);
         callbackCode=reader.getAttributeValue(null, "callback_code");
         signature.setCallbackCode(callbackCode);
         signature.setCreatedAt(callbackAt);
