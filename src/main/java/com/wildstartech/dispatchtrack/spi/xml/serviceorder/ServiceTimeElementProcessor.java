...
public class ServiceTimeElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=
         ServiceTimeElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="service_time";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            ServiceTimeElementProcessor.elementLabel);
      return ServiceTimeElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((order != null) && (reader != null)) {
         serviceTime=getElementText(reader);
         serviceTimeInt=Integer.valueOf(serviceTime);
         order.setServiceTime(serviceTimeInt);
