...
public class ReturnCodeElementProcessor 
extends XMLElementProcessor<ReturnCode> {
   private static final String _CLASS=
         ReturnCodeElementProcessor.class.getName();
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            ReturnCodeElementProcessor.elementLabel);
      return ReturnCodeElementProcessor.elementLabel;
   }

   @Override
   public void processElement(ReturnCode returnCode, XMLStreamReader reader) 
   throws XMLStreamException {
      logger.entering(_CLASS, "processElement(Image,XMLStreamReader)",
            new Object[] {returnCode,reader});
      String source=null;
      String value=null;
      String msg=null;
      
      if ((returnCode != null) && (reader != null)) {
         source=reader.getAttributeValue(null,"source");
         value=getElementText(reader);
         returnCode.setSource(source);
         returnCode.setCode(value);                  
      }  else {
         if (returnCode == null) {
