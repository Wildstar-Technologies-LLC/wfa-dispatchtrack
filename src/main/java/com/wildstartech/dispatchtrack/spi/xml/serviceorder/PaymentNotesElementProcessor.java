...
public class PaymentNotesElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=PaymentNotesElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="payment_notes";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            PaymentNotesElementProcessor.elementLabel);
      return PaymentNotesElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((order != null) && (reader != null)) {
         paymentNotes=getElementText(reader);
