...
public class Phone2ElementProcessor extends XMLElementProcessor<Customer> {
   private static final String _CLASS=Phone2ElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="phone2";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            Phone2ElementProcessor.elementLabel);
      return Phone2ElementProcessor.elementLabel;
   }
   ...
   public void processElement(Customer customer, XMLStreamReader reader) 
      ...
      if ((customer != null) && (reader != null)) {
         phone=getElementText(reader);
         customer.setPhone2(phone);        
