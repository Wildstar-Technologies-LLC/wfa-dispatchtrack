...
public class Address2ElementProcessor extends XMLElementProcessor<Customer> {
   private static final String _CLASS=Address2ElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="address2";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            Address2ElementProcessor.elementLabel);
      return Address2ElementProcessor.elementLabel;
   }
   ...
   public void processElement(Customer customer, XMLStreamReader reader) 
      ...
      if ((customer != null) && (reader != null)) {
         address2=getElementText(reader);
