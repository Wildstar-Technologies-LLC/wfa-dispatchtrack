...
public class CheckedQuantityElementProcessor 
extends XMLElementProcessor<Item> {
   private static final String _CLASS=
         CheckedQuantityElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="number";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            CheckedQuantityElementProcessor.elementLabel);
      return CheckedQuantityElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((item != null) && (reader != null)) {
         serialNumber=getElementText(reader);
