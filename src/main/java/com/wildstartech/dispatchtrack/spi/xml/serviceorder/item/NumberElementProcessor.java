...
public class NumberElementProcessor 
extends XMLElementProcessor<Item> {
   private static final String _CLASS=
         NumberElementProcessor.class.getName();
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            NumberElementProcessor.elementLabel);
      return NumberElementProcessor.elementLabel;
   }
