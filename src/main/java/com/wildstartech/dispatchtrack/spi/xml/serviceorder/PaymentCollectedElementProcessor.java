...
public class PaymentCollectedElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=PaymentCollectedElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="payment_collected";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            PaymentCollectedElementProcessor.elementLabel);
      return PaymentCollectedElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((order != null) && (reader != null)) {
         amount=getElementFloat(reader);
         order.setPaymentCollected(amount);
      } else {
         if (order == null) {
