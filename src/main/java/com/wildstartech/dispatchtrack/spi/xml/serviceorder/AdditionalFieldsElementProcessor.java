...
public class AdditionalFieldsElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=ExtraElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="additional_fields";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            AdditionalFieldsElementProcessor.elementLabel);
      return AdditionalFieldsElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      Map<String,String> additionalFields=null;
      ...
      if ((order != null) && (reader != null)) {
         ...
         if (
            ...
            additionalFields=new TreeMap<String,String>();
               ...
               switch (reader.getEventType()) {
                  ...
                  case XMLStreamConstants.END_ELEMENT:
                     ...
                     if (elementName != null) {
                        ...
                        } else if (elementName.equals(elementLabel)) {
                           done=true;
                        } // END if (elementName.equals(field))
                     } // END if (elementName != null)
                     break;
               } // END switch (reader.getEventType())
            } // END while (reader.hasNext() && (!done))
            order.setAdditionalFields(additionalFields);
         } // END if ((elementName != null) && ...       
      } else {
         if (order == null) {
