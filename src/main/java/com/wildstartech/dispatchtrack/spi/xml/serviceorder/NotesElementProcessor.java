...
public class NotesElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=NotesElementProcessor.class.getName();
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            NotesElementProcessor.elementLabel);
      return NotesElementProcessor.elementLabel;
   }
