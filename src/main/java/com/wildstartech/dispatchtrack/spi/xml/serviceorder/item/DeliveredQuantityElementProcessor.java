...
public class DeliveredQuantityElementProcessor 
extends XMLElementProcessor<Item> {
   private static final String _CLASS=
         DeliveredQuantityElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="delivered_quantity";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            DeliveredQuantityElementProcessor.elementLabel);
      return DeliveredQuantityElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((item != null) && (reader != null)) {
         number=getElementInteger(reader);
         item.setDeliveredQuantity(number);                  
      }  else {
         if (item == null) {
