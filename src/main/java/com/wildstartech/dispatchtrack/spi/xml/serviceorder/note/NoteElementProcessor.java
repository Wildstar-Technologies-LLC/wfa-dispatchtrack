 ...
 */
package com.wildstartech.dispatchtrack.spi.xml.serviceorder.note;
...
public class NoteElementProcessor 
extends XMLElementProcessor<Note> {
   private static final String _CLASS=
         NoteElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="thumbnail";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            NoteElementProcessor.elementLabel);
      return NoteElementProcessor.elementLabel;
   }

   @Override
   public void processElement(Note note, XMLStreamReader reader) 
   throws XMLStreamException {
      logger.entering(_CLASS, "processElement(Note,XMLStreamReader)",
            new Object[] {note,reader});
      Date createdAt=null;
      String author=null;
      ...
      if ((note != null) && (reader != null)) {
         value=reader.getAttributeValue(null,"author");
         value=reader.getAttributeValue(null,"created_at");
         createdAt=this.getXMLTimestampAsDate(value);
         noteText=getElementText(reader);
