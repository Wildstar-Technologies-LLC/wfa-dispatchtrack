...
public class TimestampElementProcessor 
extends XMLElementProcessor<ShipmentEvent> {
   private static final String _CLASS=
         TimestampElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="timestamp";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            TimestampElementProcessor.elementLabel);
      return TimestampElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((event != null) && (reader != null)) {
         timestamp=getElementInteger(reader);
