...
public class TimeWindowEndElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=
      TimeWindowEndElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="time_window_end";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            TimeWindowEndElementProcessor.elementLabel);
      return TimeWindowEndElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((order != null) && (reader != null)) {
         timeWindowEnd=getElementDate(reader);
         order.setTimeWindowEnd(timeWindowEnd);
      } else {
         if (order == null) {
