...
import com.wildstartech.dispatchtrack.spi.TruckImpl;
...
public class TruckElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=
         ScheduledAtElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="truck";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            TruckElementProcessor.elementLabel);
      return TruckElementProcessor.elementLabel;
   }
