...
public class StopNumberElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=
         StopNumberElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   public static final String elementLabel="stop_number";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            StopNumberElementProcessor.elementLabel);
      return StopNumberElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((order != null) && (reader != null)) {
         stopNumber=getElementInteger(reader);         
         order.setStopNumber(stopNumber);
      } else {
         if (order == null) {
