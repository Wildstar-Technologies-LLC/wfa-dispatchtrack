...
public class WarehouseNotesElementProcessor 
extends XMLElementProcessor<Item> {
   private static final String _CLASS=
         WarehouseNotesElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="warehouse_notes";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            WarehouseNotesElementProcessor.elementLabel);
      return WarehouseNotesElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((item != null) && (reader != null)) {
         warehouseNotes=getElementText(reader);
         item.setWarehouseNotes(warehouseNotes);                  
      }  else {
         if (item == null) {
