...
public class CityElementProcessor extends XMLElementProcessor<Customer> {
   private static final String _CLASS=CityElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="city";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            CityElementProcessor.elementLabel);
      return CityElementProcessor.elementLabel;
   }
