...
public class FinishedAtElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=
         FinishedAtElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="finished_at";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            FinishedAtElementProcessor.elementLabel);
      return FinishedAtElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      String msg=null;
      String finishedAtText=null;
      
      if ((order != null) && (reader != null)) {
         finishedAtText=getElementText(reader); 
         finishedAt=getXMLTimestampAsDate(finishedAtText);
