...
public class OrderHistoryElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=OrderHistoryElementProcessor.class.getName();
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            OrderHistoryElementProcessor.elementLabel);
      return OrderHistoryElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      OrderHistoryXMLFactory listFactory=null;
      List<HistoryEvent> historyEvents=null;
      String msg=null;
      
      if ((order != null) && (reader != null)) {
         listFactory=new OrderHistoryXMLFactory();
         historyEvents=listFactory.parse(reader);
