...
public class CommentElementProcessor extends XMLElementProcessor<Survey> {
   private static final String _CLASS=CommentElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="comment";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            CommentElementProcessor.elementLabel);
      return CommentElementProcessor.elementLabel;
   }
