...
public class DescriptionElementProcessor 
extends XMLElementProcessor<ShipmentEvent> {
   private static final String _CLASS=
         DescriptionElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="description";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            DescriptionElementProcessor.elementLabel);
      return DescriptionElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((event != null) && (reader != null)) {
         description=getElementText(reader);
