...
public class RequestWindowStartTimeElementProcessor 
extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=
         RequestWindowStartTimeElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="request_window_start_time";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            RequestWindowStartTimeElementProcessor.elementLabel);
      return RequestWindowStartTimeElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      String msg=null;
      String windowStartText=null;
      
      if ((order != null) && (reader != null)) {
         windowStartText=getElementText(reader); 
         windowStart=getXMLTimestampAsDate(windowStartText);
         order.setRequestWindowStartTime(windowStart);
      } else {
         if (order == null) {
