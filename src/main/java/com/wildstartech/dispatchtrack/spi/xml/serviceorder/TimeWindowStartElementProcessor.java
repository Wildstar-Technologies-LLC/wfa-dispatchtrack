...
public class TimeWindowStartElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=
      TimeWindowStartElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="time_window_start";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            TimeWindowStartElementProcessor.elementLabel);
      return TimeWindowStartElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((order != null) && (reader != null)) {
         timeWindowStart=getElementDate(reader);
         order.setTimeWindowStart(timeWindowStart);
      } else {
         if (order == null) {
