...
public class CustomerFlagElementProcessor 
extends XMLElementProcessor<ShipmentEvent> {
   private static final String _CLASS=
         CustomerFlagElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="customer_flag";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            CustomerFlagElementProcessor.elementLabel);
      return CustomerFlagElementProcessor.elementLabel;
   }

   @Override
   public void processElement(ShipmentEvent event, XMLStreamReader reader) 
   throws XMLStreamException {
      logger.entering(_CLASS, "processElement(ShipmentEvent,XMLStreamReader)",
            new Object[] {event,reader});
      String customerFlag=null;
      String msg=null;
      
      if ((event != null) && (reader != null)) {
         customerFlag=getElementText(reader);
         event.setCustomerFlag(customerFlag);
      }  else {
         if (event == null) {
      ...
      logger.exiting(_CLASS, "processElement(ShipmentEvent,XMLStreamReader)");
   }
}