...
public class ScheduledAtElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=
         ScheduledAtElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="scheduled_at";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            ScheduledAtElementProcessor.elementLabel);
      return ScheduledAtElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      String msg=null;
      String scheduledAtText=null;
      
      if ((order != null) && (reader != null)) {
         scheduledAtText=getElementText(reader); 
         scheduledAt=getXMLTimestampAsDate(scheduledAtText);
