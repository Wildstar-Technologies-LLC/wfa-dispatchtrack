...
public class RequestWindowEndTimeElementProcessor 
extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=
         RequestWindowEndTimeElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="request_window_end_time";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            RequestWindowEndTimeElementProcessor.elementLabel);
      return RequestWindowEndTimeElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      Date windowEnd=null;
      String msg=null;
      String windowEndText=null;
      
      if ((order != null) && (reader != null)) {
         windowEndText=getElementText(reader); 
         windowEnd=getXMLTimestampAsDate(windowEndText);
         order.setRequestWindowEndTime(windowEnd);
      } else {
         if (order == null) {
