...
public class QuantityElementProcessor 
extends XMLElementProcessor<Item> {
   private static final String _CLASS=
         QuantityElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="quantity";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            QuantityElementProcessor.elementLabel);
      return QuantityElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((item != null) && (reader != null)) {
         quantity=getElementInteger(reader);
