...
public class LatitudeElementProcessor extends XMLElementProcessor<Customer> {
   private static final String _CLASS=LatitudeElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="latitude";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            LatitudeElementProcessor.elementLabel);
      return LatitudeElementProcessor.elementLabel;
   }
   ...
   public void processElement(Customer customer, XMLStreamReader reader) 
      ...
      if ((customer != null) && (reader != null)) {
         latitude=getElementText(reader);
         latitudeF=Float.parseFloat(latitude);
         customer.setLatitude(latitudeF);        
