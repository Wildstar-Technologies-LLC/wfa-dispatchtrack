...
public class LongitudeElementProcessor extends XMLElementProcessor<Customer> {
   private static final String _CLASS=LongitudeElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="longitude";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            LongitudeElementProcessor.elementLabel);
      return LongitudeElementProcessor.elementLabel;
   }
   ...
   public void processElement(Customer customer, XMLStreamReader reader) 
      ...
      if ((customer != null) && (reader != null)) {
         longitude=getElementText(reader);
         longitudeF=Float.parseFloat(longitude);
         customer.setLongitude(longitudeF);        
