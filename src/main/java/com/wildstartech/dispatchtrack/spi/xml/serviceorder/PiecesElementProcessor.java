...
public class PiecesElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=
         PiecesElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   public static final String elementLabel="pieces";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            PiecesElementProcessor.elementLabel);
      return PiecesElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((order != null) && (reader != null)) {
         pieces=getElementInteger(reader);
