...
public class StatusElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=CustomerElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   public static final String elementLabel="status";   
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            StatusElementProcessor.elementLabel);
      return StatusElementProcessor.elementLabel;
   }
