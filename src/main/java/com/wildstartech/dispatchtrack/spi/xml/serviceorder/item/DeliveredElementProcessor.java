...
public class DeliveredElementProcessor 
extends XMLElementProcessor<Item> {
   private static final String _CLASS=
         DeliveredElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="delivered";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            DeliveredElementProcessor.elementLabel);
      return DeliveredElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((item != null) && (reader != null)) {
         delivered=getElementBoolean(reader);
