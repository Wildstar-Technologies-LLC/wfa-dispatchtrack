...
public class DisplayOrderNumberElementProcessor 
extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=
      DisplayOrderNumberElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   public static final String elementLabel="display_order_number";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            DisplayOrderNumberElementProcessor.elementLabel);
      return DisplayOrderNumberElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      String displayOrderNumber=null;
      
      if ((order != null) && (reader != null)) {
         displayOrderNumber=getElementText(reader);
