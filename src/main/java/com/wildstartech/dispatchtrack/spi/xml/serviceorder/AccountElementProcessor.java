...
public class AccountElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=AccountElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="account";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            AccountElementProcessor.elementLabel);
      return AccountElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      accountId=getElementText(reader);
