...
public class LocationElementProcessor 
extends XMLElementProcessor<ShipmentEvent> {
   private static final String _CLASS=
         LocationElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="location";
   ...
   public String getElementLabel() {
      ...
      logger.exiting(_CLASS, "getElementLabel()",
            LocationElementProcessor.elementLabel);
      return LocationElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      if ((event != null) && (reader != null)) {
         location=getElementText(reader);
