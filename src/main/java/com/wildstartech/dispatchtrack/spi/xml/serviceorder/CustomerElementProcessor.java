...
import com.wildstartech.dispatchtrack.spi.xml.customer.CustomerXMLFactory;

public class CustomerElementProcessor extends XMLElementProcessor<ServiceOrder> {
   private static final String _CLASS=CustomerElementProcessor.class.getName();
   private static final Logger logger=Logger.getLogger(_CLASS);
   private static final String elementLabel="customer";
   
   @Override
   public String getElementLabel() {
      logger.entering(_CLASS, "getElementLabel()");
      logger.exiting(_CLASS, "getElementLabel()",
            CustomerElementProcessor.elementLabel);
      return CustomerElementProcessor.elementLabel;
   }
   ...
   throws XMLStreamException {
      ...
      CustomerXMLFactory cFactory=null;
      if ((order != null) && (reader != null)) {
         cFactory=new CustomerXMLFactory();
         customer=cFactory.parse(reader);
         if (customer != null) {
